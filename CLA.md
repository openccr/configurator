# openCCR Contributor License Agreement (v1.0)

Thank you for your contribution to openCCR ("the Project"). In order to clarify the intellectual property license granted with your contributions, the Project requires you to accept this Contributor License Agreement ("Agreement").

---

### 1. Definitions

"Contribution" means any JavaScript, TypeScript, HTML, CSS, configuration files, documentation, test code, or other material submitted by You to the Project.
...
a) Permissive open-source licenses (e.g., MIT, Apache 2.0).
b) Reciprocal copyleft open-source licenses (e.g., GPL-3.0-or-later, LGPL).
c) Proprietary, closed-source commercial licenses granted to enterprise partners by the Project's commercial arm.
